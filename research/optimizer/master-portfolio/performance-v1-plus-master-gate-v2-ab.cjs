...
const OUT_PATH = path.join(OUT_DIR, "PERFORMANCE_V1_PLUS_MASTER_GATE_V2_AB_2026-09-21.json");
...
function main() {
  ...
  const summary = {
    schema: "performance-v1-plus-master-gate-v2-ab",
    ...
    config: {
      ...
      usarCache: false,
      performanceV1: {
        rustPatternGenerator: true,
        rankCache: true,
        leanBeam: true,
        nativeWholeGreedy: true,
        nativeLargeRound: true,
        uniqueMasksLe4: true,
        postCompactCheapLb: true,
        dffFs0: true
      },
    },
    counts: {
  ...
  console.log("PERF_GATE_SUMMARY", JSON.stringify({
    pass: summary.pass,
