...
function report(){
 ...
 console.log("SHADOW10_E2E_SUMMARY "+JSON.stringify({cases:out.cases,pairedCases:out.pairedCases,invalid:out.invalid,boards:out.boards,quality:out.quality,cpu:out.cpu,wall:out.wall,master:out.master}));
