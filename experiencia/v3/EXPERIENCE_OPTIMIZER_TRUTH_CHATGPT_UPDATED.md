...
## EXPERIMENTO RESCUE / EXPERIENCE MEMORY — 2026-09-03
- Exact cache: 3416 ms -> 1 ms, 5 placas, 0 regresiones.
- Caso difícil aprendido/repetido: 3262 ms -> 1 ms, 6 placas, 0 regresiones.
- Structural-only: baseline 3013 ms, 3286 ms; no se validó un Rescue genérico más rápido.
- Decisión: Exact Memory aprobada experimentalmente; Structural Rescue requiere router quantity-aware.
- Siguiente etapa: ExperienceRouterV2 offline con ratio/cantidades/lowerBound/features, sin modificar el motor.
